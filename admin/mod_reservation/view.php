...
if (!defined('WEB_ROOT')) {
 ...
 $code=$_GET['code'];
		...
		// 		WHERE p.`GUESTID` = g.`GUESTID` AND g.`GUESTID`='".$code."'";
    $query = " SELECT * From  `tblaccomodation`c,`tblreservation`r ,`tblguest`q , `tblroom`o where  o.ACCOMID = c.ACCOMID and  r.RESERVEID = $code    and r.ROOMID = o.ROOMID  and r.GUESTID = q.GUESTID ";
		$mydb->setQuery($query);
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a><i class="fa fa-file-text-o"></i> ARRIVAL :
                <?php echo $res->ARRIVAL; ?> </a></li>
                <li class="active"><a><i class="fa fa-file-text-o"></i> DEPARTURE : 
                <?php echo $res->DEPARTURE; ?> </a></li>
