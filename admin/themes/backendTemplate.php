...
<!-- <title>  Cornthia Hotel  <?php //echo isset($title) ? $title   :  '' ; ?></title> -->
	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
            	...
            	<?php
				$query = "SELECT count(*) as 'Total' FROM `tblreservation` WHERE `STATUS`='0'";
				$mydb->setQuery($query);
	            ...
	            ?>
	             ...
	             <li class="<?php echo (currentpage() == 'mod_room_report') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_room_report/index.php">Room Reports</a></li>
